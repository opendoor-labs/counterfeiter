...
var args = regexp.MustCompile(`(?mi)^(?:go run github\.com/maxbrunsfeld/counterfeiter|gobin -m -run github\.com/maxbrunsfeld/counterfeiter|counterfeiter|counterfeiter.exe)\s*(.*)?\s*$`)
